...
export default function FooterSection() {
    return (
        <footer className="footer">
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 2xl:mx-w-400">
                {/* Map */}
                ...
                {/* Footer Columns */}
                <div className="mt-16 grid grid-cols-2 gap-8px md:grid-cols-4">
                    ...
                    <ScrollReveal animation="fadeUp" delay={0.2}>
                        <h4 className="footer-call">Company</h4>
                        <ul role="list" className="footer-links mt-4">
